...
let prixMultiX2 = 150;
let prixMultiX3 = 500;
let prixMultiX4 = 1500;
let prixBonus = 5000;
let prixAutoclick = 12000;

function augmenterPrix(valeur) {
    if (valeur === 2) prixMultiX1 *= 2;
    if (valeur === 4) prixMultiX2 *= 2;
    if (valeur === 8) prixMultiX3 *= 3;
    if (valeur === 16) prixMultiX4 *= 4;
...
function mettreAJourPrix() {
    document.getElementById("prixMultiX1").textContent = prixMultiX1;
...
function verifierBoutons() {
    const boutonX1 = document.getElementById("X1");
    ...
    if (score < prixMultiX1) {
        boutonX1.disabled = true;
        boutonX1.classList.add("disabled-button");
    } else {
        boutonX1.disabled = false;
        boutonX1.classList.remove("disabled-button");
    }
...
document.getElementById("X2").addEventListener("click", function () {
    ...
    ajouterMultiplicateur(4, prixMultiX2);
    document.getElementById("points").textContent = score;
    augmenterPrix(2);
    mettreAJourPrix();
});
...
document.getElementById("X3").addEventListener("click", function () {
    ...
    ajouterMultiplicateur(8, prixMultiX3);
    document.getElementById("points").textContent = score;
    augmenterPrix(3);
    mettreAJourPrix();
})
...
document.getElementById("X4").addEventListener("click", function () {
    ...
    ajouterMultiplicateur(16, prixMultiX4);
    document.getElementById("points").textContent = score;
    augmenterPrix(4)
    mettreAJourPrix();
})
